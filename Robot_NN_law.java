...
public class Robot_NN_law extends AdvancedRobot {
    ...
    private double[] state_action_pre = new double[10];     //6 input, 4 output , 1 index
    private double[] state_action_for = new double[10];     //6 input, 4 output , 1 index
    ...
    neuralNet_law nn_Agent = new neuralNet_law(6,4);        //this is a Neural Net
    ...
    File state_value_file = new File("/Users/Lawrence Li/robocode/robots/Spurs/LUT_robot.data/State_Values.txt");

    public Robot_NN_law() throws IOException {
    }
    ...
    public void onWin(WinEvent event){
        ...
        state_action_pre[6+action_pre] = tmp_v;
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        //smartFire(distance);
        state_NN = state_catcher(getX(),getY(),bearing,distance,getEnergy(),e.getEnergy());
    ...
    public double[] state_catcher(double x,double y, double b,double d,double e1,double e2){
        double[] state_now = new double[6];
        state_now[0] = x;       //x-axis
        state_now[1] = y;       //y-axis
        state_now[2] = b;       //bearing
        state_now[3] = d;       //distance
        state_now[4] = e1;      //my energy
        state_now[5] = e2;      //enemy's energy
        return state_now;
    }
    /*--------Actions Methods-------*/
    ...
    public double [][] queue_to_state(CircularDoubleArrayQueue q){
        Object[] le = q.toArray();
        double[][] s =new double[le.length][6];
