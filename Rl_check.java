...
public class Rl_check extends AdvancedRobot {
    ...
    File src =new File("/Users/Lawrence Li/robocode/robots/Spurs/src.txt");
    File winrate =new File("/Users/Lawrence Li/robocode/robots/Spurs/LUT_robot.data/dest.txt");
    ...
    public void save1() {
        ...
        PrintStream w = null;
        try {
            w = new PrintStream(new FileOutputStream(src));
            for (int i=0;i<cum_reward_array.length;i++) {
